    ...
    @if($type == 'success')
        <div class="rounded-md bg-green-100 p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-semibold text-green-800">{{ $heading }}</h3>
    ...
    @if($type == 'info')
        <div class="rounded-md bg-blue-100 p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-blue-800">{{ $heading }}</h3>
    ...
    @if($type == 'warning')
        <div class="rounded-md bg-yellow-100 p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-semibold text-yellow-800">{{ $heading }}</h3>
    ...
    @if($type == 'error')
        <div class="rounded-md bg-red-100 p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-semibold text-red-800">{{ $heading }}</h3>
